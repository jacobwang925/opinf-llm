...
Usage:
    python test_utility_1d.py --predicted tool_calling_operators_nu0.5.json --model heat_model.pkl
    python test_utility_1d.py --predicted tool_calling_operators_nu0.01.json --model burgers_model_test.pkl
"""
